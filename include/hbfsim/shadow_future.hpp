...
// Deterministic CPU gold oracle only. This is not a device/control ABI and
// must not be used as evidence of GPU visibility or capacity-frame lifetime.
class ShadowFutureMachine {
  ...
  private:
    struct Record {
        ...
        std::optional<ShadowFutureCompletion> completion;
    };
