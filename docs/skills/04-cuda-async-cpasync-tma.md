...
[Async audit](../49-eval-audit/async-tma-audit.md), [execution plan C](../49-eval-audit/execution-plan.md), [claim gate G5](../49-eval-audit/claim-gates.md), [ABI](05-device-helper-and-control-abi.md), issue-stall finding (an internal working document, not published in this repository), and old async coverage finding (an internal working document, not published in this repository).
