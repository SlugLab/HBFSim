...
int main()
{
    ...
    static_assert(device::kThermalFlagTerminalFault ==
                  host_service::kThermalFlagTerminalFault);
    ...
    static_assert(offsetof(SharedControlHeader, empirical_flags) ==
                  offsetof(host_service::SharedControlHeader,
                           empirical_flags));
    static_assert(offsetof(SharedControlHeader, thermal_mode) ==
                  offsetof(host_service::SharedControlHeader, thermal_mode));
    static_assert(offsetof(SharedControlHeader, thermal_stage) ==
                  offsetof(host_service::SharedControlHeader, thermal_stage));
    static_assert(offsetof(SharedControlHeader, thermal_policy_state) ==
                  offsetof(host_service::SharedControlHeader,
                           thermal_policy_state));
    static_assert(offsetof(SharedControlHeader, thermal_scale_ppm) ==
                  offsetof(host_service::SharedControlHeader,
                           thermal_scale_ppm));
    static_assert(offsetof(SharedControlHeader, thermal_generation) ==
                  offsetof(host_service::SharedControlHeader,
                           thermal_generation));
    static_assert(offsetof(SharedControlHeader, thermal_blocked_requests) ==
                  offsetof(host_service::SharedControlHeader,
                           thermal_blocked_requests));
    static_assert(offsetof(SharedControlHeader, thermal_admission_open) ==
                  offsetof(host_service::SharedControlHeader,
                           thermal_admission_open));
    static_assert(offsetof(SharedControlHeader, thermal_flags) ==
                  offsetof(host_service::SharedControlHeader, thermal_flags));
    ...
    static_assert(hbfsim::device::fast_service_ns(10'000, 16'384,
                                                  512'000'000'000ULL) ==
                  10'032);
    static_assert(hbfsim::device::thermal_scaled_service_ns(10'032,
                                                            1'000'000) ==
                  10'032);
    static_assert(hbfsim::device::thermal_scaled_service_ns(10'032,
                                                            750'000) ==
                  13'376);
    static_assert(hbfsim::device::thermal_scaled_service_ns(1, 750'000) == 2);
