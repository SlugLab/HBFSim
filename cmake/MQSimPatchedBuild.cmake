function(hbfsim_add_patched_mqsim target_name)
    ...
    if(NOT patch_check_result EQUAL 0)
        message(FATAL_ERROR "MQSim patch check failed: ${patch_check_error}")
    endif()
    ...
    if(NOT patch_result EQUAL 0)
        message(FATAL_ERROR "MQSim patch application failed: ${patch_error}")
    endif()
    message(STATUS "MQSim HBF patch applied to clean build copy")
