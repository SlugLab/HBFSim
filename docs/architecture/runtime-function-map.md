...
| [hf_loaded_arm.py](../../scripts/eval/hf_loaded_arm.py) | `run_loaded_arm` | Private composition of one already-prepared owned request; raw return before unchanged collector, retained ownership and independent cleanup, provisional status only; parent/import/tuning/gold gates remain separate |
