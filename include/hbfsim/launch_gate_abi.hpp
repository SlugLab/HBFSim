...
inline constexpr std::uint32_t kLaunchGateAbiVersion = 1;

using LaunchGatePublishRange = int (*)(void* state) noexcept;

struct LaunchGateApiV1 {
    ...
    int (*register_timing_range)(std::uintptr_t owner,
...
using LaunchGateGetApi = const LaunchGateApiV1* (*)(
