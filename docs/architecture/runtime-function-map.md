...
| [plugin.cpp](../../src/ptxpass_hbf/plugin.cpp), [transform.cpp](../../src/ptxpass_hbf/transform.cpp) | `TrustedModuleRegistry::identity_for`, `transform_ptx` | Separate original PTX/mode/helper/contract identities and refuse incomplete future transformation; C6 emitter remains pending |
