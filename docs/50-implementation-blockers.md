...
| HOST-MEMORY | OPEN AT LAST OBSERVATION | HF004 stopped at launch because the resource monitor could not map libm.so.6; follow-up available RAM was 707,916 kB with another process at 24,263,672 kB RSS. GPU memory was then zero and owned cleanup was complete. | Preserve controller004 evidence and wait for sufficient host resources before HF005. The environment fix is not yet exercised by a real request; do not change system settings or stop unrelated jobs. |
